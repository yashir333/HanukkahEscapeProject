...
namespace SSC
{
    ...
    public class BuildAssetBundlesWindow : EditorWindow
    {
        ...
        public class EncryptionInfo
        {
            ...
            /// Crypto version
            /// </summary>
            public CryptoVersion cryptoVersion = CryptoVersion.Ver1_deprecated;
            ...
            public void reset()
            {
                ...
                this.cryptoVersion = CryptoVersion.Ver1_deprecated;
        ...
        protected virtual byte[] encryptBinaryData(byte[] data)
        {
            ...
            if(this.m_encryptionInfo.cryptoVersion == CryptoVersion.Ver1_deprecated)
            {
