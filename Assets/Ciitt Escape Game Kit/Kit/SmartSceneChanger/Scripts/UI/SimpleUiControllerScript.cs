...
namespace SSC
{
    ...
    public class SimpleUiControllerScript : UiControllerScript
    {
        ...
        /// <summary>
        /// Set CanvasGroup.alpha to 0 after hiding
        /// </summary>
        [SerializeField]
        [Tooltip("Set CanvasGroup.alpha to 0 after hiding")]
        protected bool m_setAlphaZeroAfterHiding = false;
        ...
        protected virtual void Awake()
        {
            ...
            if (this.m_hideAtAwake)
            {
                ...
                this.m_refCanvasGroup.alpha = (this.m_setAlphaZeroAfterHiding) ? 0.0f : this.m_fromAndToAlpha;
